...
.site-nav{display:flex;gap:var(--s4);font-size:12px;letter-spacing:.08em;
...
.lbl{display:flex;justify-content:space-between;gap:var(--s4);
  ...
  color:#6C6F63;border-top:1px solid var(--line);padding-top:var(--s3);margin:var(--s7) 0 0}
...
.row-meta{font-size:11px;color:#6C6F63;letter-spacing:.04em;white-space:nowrap}
a.row:hover .row-title{color:var(--lime)}
.row-date{font-size:11px;color:#6C6F63}
...
.btn.ghost{background:transparent;color:var(--paper);border-color:#33362B;
...
.copy{font:400 11px/1 var(--mono);color:var(--dim);border:1px dashed #33362B;
